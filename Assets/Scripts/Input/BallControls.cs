...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/Input/BallControls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @BallControls: IInputActionCollection2, IDisposable
{
    ...
    ~@BallControls()
    {
        ...
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, BallControls.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@BallControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
